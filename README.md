...
Nineteen self-contained papers have been developed on this artifact; each is independently readable, with all machine-checked claims anchored in this repository.
...
Papers 2–12 cite paper 1 as the platform; papers 13–15 build on the consolidated test-comparison manuscript below (paper 15 is self-contained up to the standard collage formula); paper 19 integrates and supersedes papers 16–18; release-by-release DOIs are listed in [`ARTIFACT.md`](ARTIFACT.md).
